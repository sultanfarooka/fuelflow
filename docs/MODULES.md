...
**Last Updated:** 2026-06-20 (M06-F01 — Price Configuration, In Progress)
...
### M06-F01 — Price Configuration   [Status: In Progress]
...
| ID | Requirement | Legacy | Status |
|---|---|---|---|
| M06-F01-R01 | Only one active price per fuel type per station at any time | PR-001 | In Progress |
| M06-F01-R02 | Price entered manually with explicit effective date/time | — | In Progress |
| M06-F01-R03 | Prices may differ across stations within the same organization | — | In Progress |
| M06-F01-R04 | Complete price history retained (for audits — see [M01-F08-R01](#m01-f08--audit-trail)) | — | In Progress |
