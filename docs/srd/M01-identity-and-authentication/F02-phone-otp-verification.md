...
- **2026-07-01** — Daily-cap window boundary clarified during F02 planning. Codified as a module-wide NFR in [M01 README](./README.md) (not an F02-specific R-row) — the daily cap is a calendar day aligned to Asia/Karachi, resetting at 00:00 PKT. Inherited by every M01 feature that references a daily cap (F01, F02, F03, F06, F09). See `docs/plans/M01/M01-F02.md` OQ-6 for the discovery context.
