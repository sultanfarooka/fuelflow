    ...
    <section className="relative overflow-hidden border-b bg-gradient-to-b from-primary/5 via-background to-background">
      ...
      <div className="container relative mx-auto px-4 py-20 text-center md:py-32">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground md:text-xl">
          A comprehensive management system for fuel sales, inventory, shift operations, 
          credit customers, and financial reporting — all in one place.
        </p>
...
const highlights = [
  {
    ...
    description: 'One owner, multiple stations. Consolidated dashboard with per-station data isolation.',
  },
  {
    icon: Gauge,
    title: 'Nozzle-Level Tracking',
    description: 'Track every litre sold from every nozzle. Automatic shortage and excess calculation.',
  },
  {
    icon: CreditCard,
    title: 'Credit Management',
    description: 'Manage udhaar customers with credit limits, aging reports, and automatic balance tracking.',
  },
  {
    icon: BarChart3,
    title: 'Financial Reports',
    description: 'Daily, weekly, and monthly reports with exports. Full audit trail for every transaction.',
  },
  {
    icon: Clock,
    title: 'Shift Operations',
    description: 'Open/close shifts, assign nozzlemen, collect cash, and track handover seamlessly.',
  },
  {
    icon: Globe,
    title: 'Bilingual Interface',
    description: 'Full English and Urdu support with Pakistani currency and date formatting.',
  },
]
    ...
    <section id="features" className="border-b py-16 md:py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {highlights.map((h) => (
            <Card key={h.title} className="group transition-shadow hover:shadow-md">
...
/* ================================================================== */
const modules = [
  { icon: Users, name: 'User & Access Management', desc: 'Roles, permissions, multi-station access' },
  { icon: Droplets, name: 'Fuel Inventory & Tanks', desc: 'Dip readings, stock levels, fuel receiving' },
  { icon: Gauge, name: 'Pump & Nozzle Ops', desc: 'Meter readings, sales, shortage tracking' },
  { icon: Clock, name: 'Shift Management', desc: 'Cash collection, handover, assignments' },
  { icon: CreditCard, name: 'Finance & Accounts', desc: 'Credit customers, suppliers, expenses' },
  { icon: TrendingUp, name: 'Pricing & Rates', desc: 'Fuel prices, history, dealer margins' },
  { icon: BarChart3, name: 'Reporting & Analytics', desc: 'Dashboards, exports, daily summaries' },
  { icon: Settings, name: 'Settings & Config', desc: 'Station setup, dip charts, preferences' },
  { icon: Package, name: 'Lubricants / Oil Shop', desc: 'Oil inventory, sales, stock management' },
  { icon: Bell, name: 'SMS & Notifications', desc: 'Alerts for stock, prices, shortages' },
]
    ...
    <section id="modules" className="border-b bg-muted/40 py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
            Every aspect of your filling station — from the underground tank to the customer ledger — 
            managed through purpose-built modules.
          </p>
        </div>

        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {modules.map((m, i) => (
            <Card key={m.name} className="text-center transition-shadow hover:shadow-md">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
            ...
            All plans include full access during trial.
          </p>
        </div>
                ...
                <div className="text-center">
                  ...
                  {yearly && (
                    <p className="mt-1 text-xs text-muted-foreground">
                      {formatPKR(Math.round(plan.yearlyPrice / 12))}/month billed annually
                    </p>
                  )}
                </div>
        ...
        <div className="mx-auto mt-10 max-w-2xl rounded-lg border bg-muted/50 p-6 text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Every new account gets full <span className="font-medium text-foreground">Professional</span> features 
            for 14 days. No credit card needed. When the trial ends, 
            choose a plan or your account switches to read-only mode — your data is always safe.
          </p>
          <div className="mt-4 flex flex-wrap justify-center gap-4 text-xs text-muted-foreground">
            ...
            <span className="flex items-center gap-1">
              <Check className="h-3.5 w-3.5 text-primary" /> Full features during trial
            </span>
            <span className="flex items-center gap-1">
              <Check className="h-3.5 w-3.5 text-primary" /> 3-day grace period after expiry
            </span>
            <span className="flex items-center gap-1">
              <Check className="h-3.5 w-3.5 text-primary" /> Bank transfer & JazzCash/Easypaisa
            </span>
          </div>
        </div>
      </div>
...
/* ================================================================== */
const targetUsers = [
  { role: 'Station Owners', desc: 'Full control over multiple stations with consolidated dashboards.' },
  { role: 'Station Managers', desc: 'Day-to-day operations, shift management, and reporting.' },
  { role: 'Nozzlemen / Salesmen', desc: 'Simple mobile-first interface for meter readings and shift ops.' },
  { role: 'Accountants', desc: 'Finance, ledger management, credit customers, and supplier payments.' },
]
  ...
  return (
    <section className="relative overflow-hidden py-16 md:py-24">
      ...
      <div className="container relative mx-auto px-4 text-center">
        ...
        <p className="mx-auto mt-3 max-w-lg text-muted-foreground">
          Join filling station owners across Pakistan who are saving time, reducing shortages, 
          and growing their business with Fuel Flow.
        </p>
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Button size="lg" className="gap-2">
            Start 14-Day Free Trial <ChevronRight className="h-4 w-4" />
    ...
    <footer className="border-t bg-muted/40">
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} Fuel Flow. Built for Pakistan's filling station industry.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 text-xs text-muted-foreground">
          ...
          <a href="#why" className="hover:text-foreground">Why Fuel Flow</a>
        </div>
      </div>
    </footer>
  )
